...
const (
	Rates_GetRates_FullMethodName = "/ratesgrpc.Rates/GetRates"
)
...
type RatesClient interface {
	GetRates(ctx context.Context, in *GetRatesParams, opts ...grpc.CallOption) (*Rate, error)
}
...
func (c *ratesClient) GetRates(ctx context.Context, in *GetRatesParams, opts ...grpc.CallOption) (*Rate, error) {
...
type RatesServer interface {
	GetRates(context.Context, *GetRatesParams) (*Rate, error)
...
func (UnimplementedRatesServer) GetRates(context.Context, *GetRatesParams) (*Rate, error) {
...
func _Rates_GetRates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RatesServer).GetRates(ctx, req.(*GetRatesParams))
	}
